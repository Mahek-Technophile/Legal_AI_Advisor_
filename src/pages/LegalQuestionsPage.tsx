          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-white">Legal Questions</h1>
                  <p className="text-sm text-gray-300">Get expert legal guidance</p>
                </div>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-gray-700/30 backdrop-blur-xl rounded-xl shadow-sm border border-gray-600 p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Your Legal Question</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-32 p-4 border border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none bg-gray-700/50 backdrop-blur-sm text-white placeholder-gray-400"
                  />
                </div>
                ...
                <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4 backdrop-blur-sm">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-blue-200 mb-1">Response Time</h4>
              ...
              <div className="space-y-2">
                {commonQuestions.map((q, index) => (
                  <button
                    ...
                    className="w-full text-left p-3 text-sm text-gray-300 hover:bg-gray-600/30 hover:text-white rounded-lg transition-colors border border-transparent hover:border-gray-500"
                  >
                    {q}
                  </button>
                ))}
            ...
            {/* What You'll Receive */}
            <div className="bg-gray-700/30 backdrop-blur-xl rounded-xl shadow-sm border border-gray-600 p-6">
              <h3 className="font-semibold text-white mb-4">You'll Receive:</h3>
