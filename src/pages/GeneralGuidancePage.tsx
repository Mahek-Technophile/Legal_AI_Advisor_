          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-gray-100">General Guidance</h1>
                  <p className="text-sm text-gray-400">Comprehensive legal information</p>
                </div>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl shadow-sm border border-slate-700 p-6">
              <h2 className="text-xl font-semibold text-gray-100 mb-4">Legal Topics</h2>
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-slate-700/50 backdrop-blur-sm text-gray-100 placeholder-gray-400"
                />
              </div>
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto custom-scrollbar">
                {filteredTopics.map((category, categoryIndex) => (
                  <div key={categoryIndex}>
                    <h3 className="font-medium text-gray-100 mb-2">{category.category}</h3>
                        ...
                        <button
                          ...
                          className={`w-full text-left px-3 py-2 text-sm rounded-lg transition-colors ${
                            selectedTopic === topic
                              ...
                              : 'text-gray-300 hover:bg-slate-700/50 hover:text-gray-100'
                          }`}
                        >
                          {topic}
                        </button>
            ...
            {/* Custom Inquiry */}
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl shadow-sm border border-slate-700 p-6">
              <h3 className="font-semibold text-gray-100 mb-4">Custom Inquiry</h3>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-slate-700/50 backdrop-blur-sm text-gray-100 placeholder-gray-400"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-24 px-3 py-2 border border-slate-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none bg-slate-700/50 backdrop-blur-sm text-gray-100 placeholder-gray-400"
                  />
                </div>
              </div>
            </div>
            ...
            {/* Guidance Features */}
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl shadow-sm border border-slate-700 p-6">
              <h3 className="font-semibold text-gray-100 mb-4">What You'll Get</h3>
